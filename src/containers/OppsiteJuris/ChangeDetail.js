...
export default class ChangeDetail extends Component{
    ...
    getContent=()=>{
        ...
        return(<Spin spinning={spinning}  tip="加载中...">
            {caseInfo &&  <Book className={this.state.messageH} getFrameHeight={this.getFrameHeight.bind(this)} title={title} caseInfo={caseInfo} type={caseInfo.type}></Book>}
        </Spin>)
    }
    toggle=()=>{
    ...
    goFeedback=()=>{
        ...
        history.push(`${location.pathname}/feedback/1`);
    }
    getCtrl=()=>{
