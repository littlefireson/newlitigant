            ...
            <Form>
                ...
                >
                    {getFieldDecorator('name', {
                        ...
                        <Input placeholder="请输入个体工商户名称" maxLength="50"/>
                    )}
                </FormItem>
                <FormItem
                    {...formItemLayout}
                ...
                >
                    {getFieldDecorator('unifiedSocialCode', {
                        rules: [
                            { required: true, message: '请输入15号注册号' },
                            { pattern:/^[a-zA-Z0-9]{15}$/,message:'请输入正确的注册号' }
                        ],
                    })(
                        <Input placeholder="请输入15号注册号" maxLength="15"/>
                    )}
                </FormItem>
                <FormItem
                    {...formItemLayout}
                ...
                >
                    {getFieldDecorator('certName', {
                        rules: [{ 
                            required: true, message: '请输入经营者姓名' 
                        }],
                    })(
                ...
                >
                    {getFieldDecorator('email', {
                        rules: [
                            {
                                type: 'email', message: '请输入经营者邮箱',
                            }, { 
                                required: true, message: '请输入经营者邮箱' 
                            },
                        ],
                    })(
                        <Input placeholder="请输入经营者邮箱"/>
                    )}
                </FormItem>
                <FormItem
                    {...formItemLayout}
                ...
                >
                    {getFieldDecorator('cardImageFront', {
                        rules: [
                            { required: true, message: '请上传经营者身份证正面照' },
                        ],
                    })(
                ...
                >
                    {getFieldDecorator('cardImageCon', {
                        rules: [
                            { required: true, message: '请上传经营者身份证反面照' },
                        ],
                    })(
